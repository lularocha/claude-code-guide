...
<span class="last-updated">Lastest update: January 24, 2026.</span>

## Getting Started

**Claude Code is a command-line AI tool for your development workflow.**

1. **[Install](https://code.claude.com/docs/en/quickstart)** — Claude Code installation and setup guide
...
- **[CLAUDE.md](../advanced/claude-md-guide.md)** — Project-specific instructions
- **[Advanced Techniques](../advanced/advanced-techniques.md)** — Workflows and automation
- **[Ralph Wiggun Loop](../advanced/autonomous-loops.md)** — Run Claude independently on complex tasks
