...
1. **Top-level CLAUDE.md** – Located at the root of my workspace, this file contains general instructions for how Claude should write code across all projects (this is also refered to as the System Prompt).
